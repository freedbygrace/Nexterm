...
import Enrollment from "@/pages/Settings/pages/Enrollment";
...
export const getSettingsUserPages = t => [
    ...
    { title: t("settings.pages.enrollment"), key: "enrollment", icon: mdiCloudKeyOutline, content: <Enrollment /> },
