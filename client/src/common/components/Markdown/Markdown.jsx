...
/**
 * Renders Markdown from marked's token stream rather than its HTML output: no dangerouslySetInnerHTML,
 * so text written by a user (a note, an AI answer) can never inject markup.
 *
 * The inner class names are shared with the callers' own stylesheets, which may add to them.
 */
