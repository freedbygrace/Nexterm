...
/**
 * Releases the per-channel display state associated with the given SPICE
 * display channel (invoked when the channel is being destroyed) and recomposes
 * the combined display without it.
 *
 * @param client
 *     The guac_client associated with the SPICE connection.
 *
 * @param channel
 *     The SPICE display channel being destroyed.
 */
